...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        Library:MakeLine(PlayerIconFrame, {
            Position = UDim2.fromOffset(0, 0),
            Size = UDim2.new(1, 0, 0, 1),
        })
        New("UIListLayout", {
        ...
        local PlayerAvatarImage = New("ImageLabel", {
            BackgroundTransparency = 1,
        ...
        task.spawn(function()
            ...
            if success and thumbUrl then
                PlayerAvatarImage.Image = thumbUrl
            else
                PlayerAvatarImage.Image = string.format("rbxthumb://type=AvatarHeadShot&id=%s&w=48&h=48", tostring(LocalPlayer.UserId))
            end
        end)

        PlayerNameLabel = New("TextLabel", {
            AutomaticSize = Enum.AutomaticSize.X,
            BackgroundTransparency = 1,
    ...
    function Window:SetSidebarWidth(Width)
        ...
        PlayerIconFrame.Size = UDim2.new(0, Width, 0, 48)
        PlayerNameLabel.Visible = Width > WindowInfo.SidebarCompactWidth
    ...
    function Window:AddTab(...)
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                ...
                local CollapseIcon = New("ImageLabel", {
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    BackgroundTransparency = 1,
                    Position = UDim2.fromScale(0.5, 0.5),
                    Size = UDim2.fromOffset(16, 16),
                ...
                CollapseButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(CollapseIcon, Library.TweenInfo, {
                    ...
                    if IsCollapsed then
                        ...
                        local TargetSize = (GroupboxList.AbsoluteContentSize.Y / Library.DPIScale) + 49
                        TweenService:Create(GroupboxHolder, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
            ...
            function Groupbox:Resize()
                if not GroupboxContainer.Visible then return end
